...
(function () {
    ...
    */
    ...
    const COMMANDS = {
        'Q1': `Выполни полный, точный и смысловой перевод предоставленного документа на русский язык.
Переведи весь текст полностью, без сокращений, пересказа, пропусков и собственных пояснений.
Сохрани исходную структуру и форматирование:
- порядок страниц;
- заголовки и подзаголовки;
- абзацы и переносы строк;
- нумерацию и списки;
- таблицы, колонки и подписи к полям;
- подписи, примечания и приложения.
Не объединяй разные абзацы и не меняй порядок информации.
Имена и фамилии людей, адреса, названия улиц, номера телефонов, электронную почту, номера дел, договоров, счетов и справок, банковские реквизиты, IBAN, BIC, даты и суммы сохраняй точно так, как они указаны в оригинале.
Официальные названия организаций, ведомств, законов, должностей и документов переводи понятно на русский язык. При необходимости после перевода указывай оригинальное название в скобках.
Юридические, медицинские, административные и технические формулировки переводи точно, без изменения их смысла.
Не исправляй предполагаемые ошибки оригинала и не выдумывай отсутствующие сведения.
Неразборчивые фрагменты обозначай как [неразборчиво].
Страницы обозначай:
СТРАНИЦА 1:
СТРАНИЦА 2:
и далее.
В ответе предоставь только готовый перевод без вступления, комментариев, выводов и краткого содержания.`,

        'Q2': ` Сделай краткое смысловое описание предоставленного письма или документа на русском языке строго в одну строку и одним предложением.
Укажи:
- кто кому пишет или сообщает;
- по какому вопросу;
- что является главным содержанием, решением, требованием или просьбой;
- важные даты, сроки, суммы и необходимые действия, если они существенны.
Не пересказывай весь текст, не добавляй собственных выводов, заголовков, списков и пояснений.
Не используй переносы строк.
В ответе предоставь только готовое описание. `,
